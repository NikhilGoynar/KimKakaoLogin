...
class UserSignUp02Widget extends StatefulWidget {
  const UserSignUp02Widget({Key? key}) : super(key: key);

  @override
  _UserSignUp02WidgetState createState() => _UserSignUp02WidgetState();
}

class _UserSignUp02WidgetState extends State<UserSignUp02Widget> {
  String? areaDDValue;
