...
class IndexProblemWidget extends StatefulWidget {
  const IndexProblemWidget({
    Key? key,
    this.problemRef,
  }) : super(key: key);

  final DocumentReference? problemRef;

  @override
  _IndexProblemWidgetState createState() => _IndexProblemWidgetState();
}

class _IndexProblemWidgetState extends State<IndexProblemWidget> {
    ...
    return Scaffold(
      ...
      body: GestureDetector(
        ...
        child: Column(
          ...
          children: [
            Expanded(
              child: StreamBuilder<ProblemRecord>(
                stream: ProblemRecord.getDocument(widget.problemRef!),
                builder: (context, snapshot) {
                  ...
                  final columnProblemRecord = snapshot.data!;
                          ...
                          child: Row(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  columnProblemRecord.problemList!,
