...
abstract class CommentsRecord
  ...
  @BuiltValueField(wireName: 'det_user')
  DocumentReference? get detUser;
  ...
  @BuiltValueField(wireName: 'file_list')
  BuiltList<String>? get fileList;
